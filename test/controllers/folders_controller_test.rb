...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference("Folder.count") do
      post folders_url, params: { folder: { description: @folder.description, title: @folder.title } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { description: @folder.description, title: @folder.title } }
