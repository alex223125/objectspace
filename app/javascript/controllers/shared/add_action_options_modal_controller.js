...
export default class extends Controller {
    ...
    initialize() {
        console.log("Add action options controller initialized")
    }

    connect() {
        console.log("Add action options controller connected")
    ...
    disconnect() {
        console.log("Add action options controller disconnected")
        this.close();
    }
    ...
    _backgroundHTML() {
        ...
        return `<div id="${this.backgroundId}" class="fixed top-0 left-0 w-full h-full" style="background-color: ${this.backdropColorValue}; z-index: 9;"></div>`;
    }
    ...
    lockScroll() {
        ...
        // doesnt work (Moves body of page to top)
