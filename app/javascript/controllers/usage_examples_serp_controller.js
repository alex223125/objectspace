...
export default class extends Controller {
    ...
    connect() {
        console.log("usage examples serp connected")
        this.intersectionObserver.observe(this.paginationTarget)
    }

    disconnect() {
        console.log("usage examples serp disconnected")
    ...
    loadMore() {
        ...
        let url = `/unit_usage_examples?unit_version_id=${this.unitVersionId}&page=${this.page}`
        Rails.ajax({
            type: 'GET',
            url: url,
            dataType: 'json',
