...
export default class extends Controller {
    ...
    static targets = ['substepsArea', 'substepPositionVisibleField', 'substepPositionHiddenField'];
    ...
    currentStepsAmount(){
        ...
        // return this.substepsAreaTarget.querySelectorAll('.substep-position-hidden-field').length
        return this.substepPositionVisibleFieldTargets.length
    }
    ...
    recalculateIndexes(){
        ...
        var positionHiddenElemenets = [...this.substepPositionHiddenFieldTargets]
        ...
        var positionHiddenElemenets = [...this.substepPositionVisibleFieldTargets]
        positionHiddenElemenets.forEach(function callback(value, index) {
