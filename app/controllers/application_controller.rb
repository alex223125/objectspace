class ApplicationController < ActionController::Base
  ...
  def class_containers_attributes
    {        class_containers_attributes: [:id, :position, :title, :creator_id, :functional_type, :description, :_destroy,
                                           containers_attributes: [:id, :position, :title, :creator_id, :functional_type, :description, :_destroy, recursive_nested_containers_attr,
  ...
  def interface_groups_attributes
    {interface_groups_attributes: [:id, :position, :title, :description, :functional_type, :creator_id, :_destroy,
                                   groups_attributes: [:id, :position, :title, :description, :functional_type, :creator_id, :_destroy, recursive_nested_groups_attr,
  ...
  def recursive_nested_containers_attr
    build_recursive_params(
      ...
      parameters: params,
      permitted_attributes: [:id, :position, :title, :creator_id, :functional_type, :description, :_destroy]
    )
  end
  ...
  def recursive_nested_groups_attr
    build_recursive_params(
      ...
      parameters: params,
      permitted_attributes: [:id, :position, :title, :description, :functional_type, :creator_id, :_destroy]
    )
  end
