class SharedClassLayer::ClassContainersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if service.errors.blank?
        binding.pry
        format.html { redirect_to class_container_path(ownername: service.class_container.related_class_layer_entity.ownerable.ownername,
