class SharedClassLayer::InterfaceMembersController < ApplicationController
  ...
  def show
    ...
    elsif @interface_member.memberable.class == Algorithms::Algorithm
      binding.pry
      @algorithm_version = @interface_member.memberable.default_version
